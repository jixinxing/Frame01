...
//		recyclerView.setAdapter(mainFragmentTab01Adapter);
        ...
        MainFragmentTab01Adapter mainFragmentTab01Adapter = new MainFragmentTab01Adapter(this.getActivity(), dataList);//自己的adapter,作为LRecyclerViewAdapter的参数
        ...
        recyclerView.setRefreshing(true);//强制刷新
